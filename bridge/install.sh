...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Running as a system service (production)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Option A — systemd (recommended on Ubuntu/Debian):"
echo "  sudo cp $(dirname "$0")/agent-bridge.service /etc/systemd/system/"
echo "  sudo systemctl daemon-reload"
echo "  sudo systemctl enable agent-bridge"
echo "  sudo systemctl start agent-bridge"
echo "  sudo systemctl status agent-bridge"
echo ""
echo "Option B — PM2 (if you prefer PM2):"
echo "  npm install -g pm2"
echo "  pm2 start $(dirname "$0")/pm2.config.js"
echo "  pm2 save"
